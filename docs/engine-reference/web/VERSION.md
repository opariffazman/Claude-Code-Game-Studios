...
- **PixiJS**: Training data covers up to ~7.x. **PixiJS v8 is a complete rewrite**
  ...
  InteractionManager APIs all changed fundamentally. See `pixijs/` subdirectory
  for comprehensive v8 reference (VERSION, BREAKING-CHANGES, DEPRECATED-APIS,
...
| Version | Release | Risk Level | Key Theme |
|---------|---------|------------|-----------|
| v8.0.0 | Mar 2024 | CRITICAL | Complete rewrite — async init, new Graphics API, Assets replaces Loader, WebGPU |
| v8.1–8.13 | 2024–Sep 2025 | HIGH | Stabilization, ParticleContainer rewrite, bug fixes |
| v8.16.0 | Feb 2026 | HIGH | Experimental Canvas renderer, tagged text support |
| v8.17.0 | Mar 2026 | HIGH | Optimized BlurFilter, text alignment fixes, visibleChanged event |
